---
id: PR128-REVIEW2-STORE-SCAN-HANGS-ON-A-FIFO
severity: P2
disposition: deferred
category: liveness
pr: 128
reviewed_sha: f161c9e8555c88474f09f89f095737346070d334
location: src/workspace_manager.rs:3037
...
the scan opened every name ending in `.pack` or `.idx` without checking its file type -> a FIFO named `objects/pack/ignored.pack`, which git ignores, blocks `File::open` until a writer appears -> a residue classification, or any `object_exists`, hangs for ever, with no timeout or cancellation anywhere on the path; reproduced by the reviewer
