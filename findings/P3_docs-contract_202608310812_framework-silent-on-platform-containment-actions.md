---
id: PR3-FRAMEWORK-SILENT-5
severity: P3
disposition: deferred
category: docs-contract
pr: 3
reviewed_sha: 7dfbf8b0cb1203671300a097ca9be1c8107732a3
location: src/topology/effects/residue_authority.rs:510
...
Windows and Unix containment kills get distinct actions (`AmbientHandleTerminates`, `ReaperSettlesGroup`) though the packet's residue answer is "none" for both

## What the change that takes this up should do

Owner, as the ledger records it: PR7–PR10 implementer.

The mechanisms the packet states are different, and a table that merged them would survive a swap
