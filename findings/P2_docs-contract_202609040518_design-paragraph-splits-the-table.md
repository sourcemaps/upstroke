---
id: PR128-REVIEW2-DESIGN-PARAGRAPH-SPLITS-THE-TABLE
severity: P2
disposition: deferred
category: docs-contract
pr: 128
reviewed_sha: f161c9e8555c88474f09f89f095737346070d334
location: design/26_design_merge_queue_protocol.md:304
...
the added paragraph was placed before the resume table's last row -> the blank line terminated the table -> the `task_merged` row rendered as orphaned pipe text, so the change altered the structure of the sole design authority rather than adding to it
