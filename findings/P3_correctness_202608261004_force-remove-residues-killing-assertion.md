---
id: PR5-WORKSPACE-068
severity: P3
disposition: deferred
category: correctness
pr: 5
reviewed_sha: 
location: src/workspace_manager/tests.rs:11286
...
A withheld-mutation-catalogue entry targeting `force_remove_residue` (`src/workspace_manager.rs:7585`). On re-measurement against the shipped
